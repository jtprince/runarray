...
# Vector class for basic vector routines and mathematical
# operations/calculations on vectors. 
# By default, this is built for doubles.  However, it can be subclassed for a 
# Preferable to use VecD if you want to ensure double behavior
# @TODO: implement on top of NArray (if installed?)
class Vec < Array
...
=end
  ...
  # Returns a VecD object (of doubles)
